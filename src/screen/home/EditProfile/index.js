	...
	return (
		<ScrollView style={{backgroundColor: '#fff'}}>
			...
			<View style={{backgroundColor: '#fff', padding: 25}}>
				<Text style={styles.profileText}>P R O F I L E</Text>
				<Text style={styles.ankasaText2}>Profile</Text>
			</View>

			<View style={{backgroundColor: '#fff', padding: 25}}>
				<Text style={styles.Textsama2}>Username</Text>
			...
			<View style={{backgroundColor: '#fff', padding: 25}}>
				<Text style={styles.Textsama2}>City</Text>
				<View style={styles.inputItem}>
					<TextInput
						editable={false}
						value={city}
			...
			<View style={{backgroundColor: '#fff', padding: 25}}>
				<Text style={styles.Textsama2}>Address</Text>
				<View style={styles.inputItem}>
					<TextInput
						value={address}
						style={{width: '90%'}}
			...
			<View style={{backgroundColor: '#fff', padding: 25}}>
				<Text style={styles.Textsama2}>Post Code</Text>
				<View style={styles.inputItem}>
					<TextInput
						value={postcode}
						style={{width: '90%'}}
