    ...
    <ScrollView style={{backgroundColor: '#fff'}}>
      <View style={{flex: 1, backgroundColor: '#F8F8F8', borderRadius: 30}}>
        <View style={styles.jumbotron}>
          ...
          <Text
            style={styles.tokyoText}>
            Tokyo
          </Text>

          <Text
            style={styles.japanText}>
            Japan
          </Text>
      ...
      <View>
      <Result airplane="Garuda Indonesia" price="$ 214,00" terminal="Terminal A" />
